...
1. Take RGB input
2. Calculate validation/test performance in addition to training
3. Reduce channel widths during h-parameters sweep
...
def get_unet0():
    ...
    conv1 = BatchNormalization(mode=0, axis=1)(inputs)
    ...
    conv2 = BatchNormalization(mode=0, axis=1)(pool1)
    ...
    conv3 = BatchNormalization(mode=0, axis=1)(pool2)
    ...
    conv4 = BatchNormalization(mode=0, axis=1)(pool3)
    ...
    conv5 = BatchNormalization(mode=0, axis=1)(pool4)
    ...
    conv6 = BatchNormalization(mode=0, axis=1)(up6)
    ...
    conv7 = BatchNormalization(mode=0, axis=1)(up7)
    ...
    conv8 = BatchNormalization(mode=0, axis=1)(up8)
    ...
    conv9 = BatchNormalization(mode=0, axis=1)(up9)
...
def form_batch_val(X, y, batch_size):
...
if __name__ == '__main__':
    ...
    suffix = 'buildings_3_unet1_medium_coco'+"{batch}_{epoch}".format(batch=batch_size,epoch=nb_epoch)
