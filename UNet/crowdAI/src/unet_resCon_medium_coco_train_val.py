...
1. Have local residual connections inspired by Resnet
2. Take RGB input
3. Calculate validation/test performance in addition to training
4. Reduce channel widths during h-parameters sweep
...
if __name__ == '__main__':
    ...
    suffix = 'buildings_3_resnet_medium_coco_eval'+"{batch}_{epoch}".format(batch=batch_size,epoch=nb_epoch)
