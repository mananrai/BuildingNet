...
def compute_backbone_shapes(config, image_shape):
    ...
    assert config.BACKBONE in ["resnet50", "resnet101", "resnext50", "resnext101"]
    return np.array(
...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        if self.backbone == "resnet":
            ...
            _, C2, C3, C4, C5 = resnext.resnext_graph(input_image, 'resnext50', stage5=True, train_bn=config.TRAIN_BN)
