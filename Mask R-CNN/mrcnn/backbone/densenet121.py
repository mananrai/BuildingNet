...
def densenet121_graph(input_tensor, nb_dense_block=4, growth_rate=32, nb_filter=64, reduction=0.0, dropout_rate=0.0, weight_decay=1e-4, classes=1000, weights_path=None):
    ...
    x = KL.Conv2D(nb_filter, 7, 7, subsample=(2, 2), name='conv1', bias=False)(x)
...
def conv_block(x, stage, branch, nb_filter, dropout_rate=None, weight_decay=1e-4):
    ...
    x = KL.Conv2D(nb_filter, 3, 3, name=conv_name_base+'_x2', bias=False)(x)
...
def transition_block(x, stage, nb_filter, compression=1.0, dropout_rate=None, weight_decay=1E-4):
    ...
    x = KL.Conv2D(int(nb_filter * compression), 1, 1, name=conv_name_base, bias=False)(x)
